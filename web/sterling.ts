...
export function maxMarkup(world:World,voice:MaxVoice|undefined,busy:boolean,status:string){
 ...
 <div class="offer-slip"><span>VOLT MOTORS ELECTRIC-BUS PILOT</span><b>${pilotDaysLeft(world)?`Running · ${pilotDaysLeft(world)} days remaining`:`${offer.cost} treasury · 3 days · oil demand −2 per day`}</b><small>No permanent upgrade. Discuss terms within today. Fund, decline or call out the pitch to complete the meeting. Treasury: ${world.state.treasury}.</small></div>
